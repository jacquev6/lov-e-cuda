...
TEST(ArrayViewHostDeviceTest, PassToHostDeviceFunction1D) {
  ...
  EXPECT_EQ(host_device_function_1d(h_a), 0);

  ArrayView1D<Host, int> h_av(h_a);
  EXPECT_EQ(host_device_function_1d(h_av), 0);

  Array1D<Device, int> d_a(1, zeroed);
  kernel_ArrayViewHostDeviceTest_PassToHostDeviceFunction1D<<<1, 1>>>(d_a);
...
TEST(ArrayViewHostDeviceTest, PassToHostDeviceFunction1DConst) {
  ...
  Array1D<Device, int> d_a(1, zeroed);
  kernel_ArrayViewHostDeviceTest_PassToHostDeviceFunction1DConst<<<1, 1>>>(d_a);
  check_last_cuda_error();
}
...
TEST(ArrayViewHostDeviceTest, PassToHostDeviceFunction3D) {
  ...
  EXPECT_EQ(host_device_function_3d(h_a), 0);

  ArrayView3D<Host, int> h_av(h_a);
  EXPECT_EQ(host_device_function_3d(h_av), 0);

  Array3D<Device, int> d_a(1, 1, 1, zeroed);
  kernel_ArrayViewHostDeviceTest_PassToHostDeviceFunction3D<<<1, 1>>>(d_a);
  check_last_cuda_error();
}
...
TEST(ArrayViewHostDeviceTest, PassToHostDeviceFunction3DConst) {
  ...
  Array3D<Device, int> d_a(1, 1, 1, zeroed);
  kernel_ArrayViewHostDeviceTest_PassToHostDeviceFunction3DConst<<<1, 1>>>(d_a);
  check_last_cuda_error();
}
